...
return [
    ...
    'ldap_fail_authed' => 'Не удалось получить доступ к LDAP, используя данные DN и пароль',
    'ldap_extension_not_installed' => 'Расширение LDAP для PHP не установлено',
    ...
    'social_account_in_use' => 'Этот :socialAccount аккаунт уже используется, Попробуйте войти с параматрами :socialAccount.',
    ...
    'social_driver_not_found' => 'Драйвер соцсети не найден',
    ...
    'cannot_create_thumbs' => 'Сервер не может создавать уменьшенную копию изображений. Убедитесь, что у вас установлено расширение GD PHP.',
