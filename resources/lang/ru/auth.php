...
return [
    ...
    */
    ...
    'ldap_email_hint' => 'Введите электронную почту для данной учётной записи.',
    ...
    'email_reset_text' => 'Вы получили это электронное письмо, потому что мы получили запрос на сброс пароля для вашей учётной записи.',
    'email_reset_not_requested' => 'Если вы не запрашивали сброса пароля, то никаких дополнительных действий не требуется.',

    /*
     * Email Confirmation
     */
    'email_confirm_subject' => 'Подтвердите вашу электронную почту на :appName',
    'email_confirm_greeting' => 'Благодарим за участие :appName!',
    'email_confirm_text' => 'Пожалуйста, подтвердите вашу электронную почту, кликнув на кнопку ниже:',
    'email_confirm_action' => 'Подтвердить электронную почту',
    ...
    'email_confirm_success' => 'Ваша электронная почта была подтверждена!',
    'email_confirm_resent' => 'Письмо с подтверждением было выслано снова. Пожалуйста, проверьте вашу электронную почту.',

    'email_not_confirmed' => 'Электронная почта не подтверждена',
    'email_not_confirmed_text' => 'Ваша электронная почта всё ещё не подтверждена.',
    'email_not_confirmed_click_link' => 'Пожалуйста, нажмите на ссылку в письме, которое было отправлено при регистрации.',
    'email_not_confirmed_resend' => 'Если вы не можете найти электронное письмо, вы можете снова запросить письмо с подтверждением по форме ниже.',
    'email_not_confirmed_resend_button' => 'Отправить снова письмо с подтверждением',
];
