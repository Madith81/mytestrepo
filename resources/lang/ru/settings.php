...
return [
    ...
    'app_logo_desc' => 'Это изображение должно быть 43 пикселя в высоту. <br>Большее изображение будет уменьшено.',
    'app_primary_color' => 'Главный цвет приложения',
    'app_primary_color_desc' => 'Он должен быть указан шестнадцатеричным кодом. <br>Оставьте пустым чтобы использовать цвет по умолчанию.',
    ...
    'users_external_auth_id' => 'Внешний идентификатор аутентификации',
    ...
    'users_social_connected' => ':socialAccount аккаунт успешно подключён к вашему профилю.',
