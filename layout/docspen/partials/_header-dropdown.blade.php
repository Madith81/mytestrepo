<div class="dropdown-container" dropdown>
    <span class="user-name" dropdown-toggle>
        ...
        <span class="name">{{ $currentUser->getShortName(10) }}</span> @icon('caret-down')
    </span>
    <ul>
        <li>
            <a href="{{ baseUrl("/@/{$currentUser->id}") }}" class="text-primary">@icon('user'){{ $currentUser->getShortName(10) }}</a>
        </li>
        <li>
