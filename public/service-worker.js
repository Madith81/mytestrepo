! function (e) {
    ...
    self.addEventListener("install", function (e) {
        ...
        if (e.action) {
            ...
            t = n.i(c.a)(e, ["notification", "data", "payload", "landingUrl"]);
        }
    ...
    o.a.router.get("/npm/(.*)", o.a.cacheFirst, {
        ...
        origin: "https://chart.googleapis.com",
        cache: {
            name: u.fonts,
            maxEntries: 5
        }
    ...
    ! function () {
        function e(e)
        {
            for (var n = void 0, r = void 0, o = void 0, a = void 0, i = [], c = unescape(encodeURI(e)), s = c.length, u = [n = 1732584193, r = -271733879, ~n, ~r], f = 0; f <= s;) {
                i[f >> 2] |= (c.charCodeAt(f) || 128) << f++ % 4 * 8;
            }
            for (i[e = 16 * (s + 8 >> 6) + 14] = 8 * s, f = 0; f < e; f += 16) {
                for (s = u, a = 0; a < 64;) {
                    s = [o = s[3], (n = 0 | s[1]) + ((o = s[0] + [n & (r = s[2]) | ~n & o, o & n | ~o & r, n ^ r ^ o, r ^ (n | ~o)][s = a >> 4] + (t[a] + (0 | i[[a, 5 * a + 1, 3 * a + 5, 7 * a][s] % 16 + f]))) << (s = [7, 12, 17, 22, 5, 9, 14, 20, 4, 11, 16, 23, 6, 10, 15, 21][4 * s + a++ % 4]) | o >>> 32 - s), n, r];
                }
                for (a = 4; a;) {
                    u[--a] = u[a] + s[a]
                }
            ...
            for (e = ""; a < 32;) {
                e += (u[a >> 3] >> 4 * (1 ^ 7 & a++) & 15).toString(16);
            }
            return e
        }
        for (var t = [], n = 0; n < 64;) {
            t[n] = 0 | 4294967296 * Math.abs(Math.sin(++n))
        }
    }()
}, function (e, t, n) {
    "use strict";
    ...
    function r(e, t, n)
    {
        ...
        return a.debug("Strategy: network first [" + e.url + "]", n), a.openCache(n).then(function (t) {
            ...
            var f = a.fetchAndCache(e, n).then(function (e) {
                if (o && clearTimeout(o), r.test(e.status)) {
                    return e;
                }
    ...
    function r(e, t)
    {
        for (var n, r = [], o = 0, a = 0, i = "", c = t && t.delimiter || "/"; null != (n = x.exec(e));) {
            var f = n[0],
                p = n[1],
                h = n.index;
            if (i += e.slice(a, h), a = h + f.length, p) {
                i += p[1];
            } else {
                var l = e[a],
                    d = n[2],
        ...
        return function (n, r) {
            for (var o = "", c = n || {}, s = r || {}, u = s.pretty ? a : encodeURIComponent, f = 0; f < e.length; f++) {
                ...
                if ("string" != typeof p) {
                    ...
                    if (m(l)) {
                        if (!p.repeat) {
                            throw new TypeError('Expected "' + p.name + '" to not repeat, but received `' + JSON.stringify(l) + "`");
                        }
                        if (0 === l.length) {
                            if (p.optional) {
                                continue;
                        ...
                        for (var d = 0; d < l.length; d++) {
                            if (h = u(l[d]), !t[f].test(h)) {
                                throw new TypeError('Expected all "' + p.name + '" to match "' + p.pattern + '", but received `' + JSON.stringify(h) + "`");
                            }
                            o += (0 === d ? p.prefix : p.delimiter) + h
                        }
                    } else {
                        if (h = p.asterisk ? i(l) : u(l), !t[f].test(h)) {
                            throw new TypeError('Expected "' + p.name + '" to match "' + p.pattern + '", but received "' + h + '"');
                        }
                        o += p.prefix + h
                    }
                } else {
