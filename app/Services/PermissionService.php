...
class PermissionService
{
    ...
    {
        return $this->book->newQuery()->select(['id', 'restricted', 'created_by'])->with(
    ...
    {
        $pageSelect = $this->db->table('pages')->selectRaw($this->page->entityRawQuery($fetchPageContent))->where('book_id', '=', $book_id)->where(
