...
Route::get('/swags', 'OthersController@swags');
Route::get('/hello', 'OthersController@hello');
Route::get('/radio', 'OthersController@radio');
Route::get('/feed/radio', 'OthersController@radiofeed');
...
// XMLs
Route::get('/opensearch.xml', 'OthersController@opensearch');
