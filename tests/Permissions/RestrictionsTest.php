...
class RestrictionsTest extends BrowserKitTest
{
    ...
    public function test_book_sort_permission()
    {
        ...
        $firstBookChapter = $this->app[EntityRepo::class]->createFromInput(
            'chapter',
            ['name' => 'first book chapter'],
            $firstBook
        );
        $secondBookChapter = $this->app[EntityRepo::class]->createFromInput(
            'chapter',
            ['name' => 'second book chapter'],
            $secondBook
        );
